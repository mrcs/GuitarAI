...
public class Gui extends JFrame {
	...
	private void ok() {
		if (tutor.temQuestao()) {
			...
			tutor.responde(new Questao(acordeAtual), resposta);
	...
	private void play() {
		//player.play("T[20] I[Guitar] "+parser(this.acordeAtual.getNome()));
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel4 = new JLabel();
			jLabel4.setBounds(new Rectangle(250, 21, 48, 17));
			jLabel4.setText("");
			jLabel3 = new JLabel();
			jLabel3.setBounds(new Rectangle(146, 21, 80, 17));
			jLabel3.setText("Acorde:");
			jLabel2 = new JLabel();
			...
			diagrama.setText("");
			// diagrama.setIcon(new
			// ImageIcon(getClass().getResource("/imagens/A7_Guitar_Chord.gif"
			// )));
			jLabel = new JLabel();
	...
	private void mudarDiagrama(String nome) {
		diagrama.setIcon(new ImageIcon(getClass().getResource(
				"/imagens/" + nome.replaceFirst("#", "sharp")
						+ "_Guitar_Chord.gif")));
	}
	
	private String parser(String nome){
		return nome.replaceFirst("#", "sharp").replaceFirst("m", "min");
	}
